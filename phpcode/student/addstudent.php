...
<html>
 ...
 <body>
  <form name=f1 action="./add.php" method="POST">
      学号：<input type="text" name="sno" size="20" maxlength="9" value="" /><br />
      姓名：<input type="text" name="sname" size="20" maxlength="20" value="" /><br />
      性别：<select name="ssex">
       <option value=""></option>
      ...
      <br />
	   班级：<input type="text" name="sclass" size="20" maxlength="7" value="" /><br />
      ...
      <option value="">日</option>
	   ...
	   <br />
      电话：<input type="text" name="stel" size="20" maxlength="20" value="" /><br />
      地址：<input type="text" name="saddr" size="80" maxlength="50" value="" /><br />
      备注：<input type="text" name="scmt" size="80" maxlength="50" value="" /><br />
